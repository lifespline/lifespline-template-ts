...
This document explains the testing and linting frameworks included in the framework, and specifies how to setup your environment, lint and test a [typescript](https://www.typescriptlang.org/) project with the `hawk-typescript-template` bootstrap on [vscode](https://code.visualstudio.com/).
